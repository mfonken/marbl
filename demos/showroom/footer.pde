...
void drawFooter() {
  ...
  stroke(255, 200, 100);
  drawFooterDial("Pitch", footer_x + (int)lerp(rot_dial_start, rot_dial_end, 0.2), HALF_PI - p_lock);
  stroke(100, 255, 200);
  ...
  drawCoordinateText( (int)(footer_x + rot_dial_end + 4 ), x * PIXELS_TO_UNITS, y * PIXELS_TO_UNITS, z * PIXELS_TO_UNITS );
