 ...
 *  Structure to register handler functions to button press events. */
typedef struct {
  AppUiBtnEvt_t buttonEventId;  /**< Button event enumeration. */
  void (*fctn)(void);           /**< Handler function. */
} AppCfgButtonEvent_t;
...
extern AppCfgButtonEvent_t appCfgButtonEvent[];
